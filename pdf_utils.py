...
# Singleton instance
_CACHED_PADDLE_ENGINE = None

def get_paddle_engine():
    """Returns a singleton instance of the PaddleOCR engine."""
    global _CACHED_PADDLE_ENGINE
    if _CACHED_PADDLE_ENGINE is None:
        ...
        # usage of use_onnx=False to avoid INVALID_PROTOBUF error with local models
        _CACHED_PADDLE_ENGINE = PPStructure(recovery=True, lang='en', show_log=False, use_gpu=False,
