...
TOOL_PAGES: Dict[str, dict] = {
    ...
    "ocr-pdf": {
        "title": "OCR PDF: Make a PDF Searchable Online Free | Forge Files",
        "meta": "OCR a scanned PDF into a searchable PDF online. Add an invisible text layer so Ctrl+F works. Free, no signup, open source, files deleted automatically.",
        "h1": "OCR PDF: Make Scanned PDFs Searchable",
        "lede": "Turn an image-only scan into the same-looking PDF with a searchable text layer. Keep the original page image, add OCR text behind it, and download a PDF that works with search.",
        "tool": "pdf", "app": "OCR PDF", "cta": "Make PDF searchable, free",
        "how": "How to OCR a PDF",
        "steps": [
            "Upload your scanned or image-only PDF.",
            "Choose <strong>OCR PDF</strong>. English OCR is available in this free tool.",
            "Download the searchable PDF. Your upload is deleted automatically.",
        ],
        "benefits": [
            "<strong>Searchable output:</strong> keep the original scan visuals while adding invisible OCR text for search and copy.",
            "<strong>Built for scanned documents:</strong> use this when you need a searchable PDF, and use <a href=\"/pdf-to-text\">PDF to Text</a> when you want a .txt export.",
            "<strong>Private by design:</strong> files are deleted after processing, and the <a href=\"" + GITHUB + "\" target=\"_blank\" rel=\"noopener\">source is open</a>.",
        ],
        "faqs": [
            ("Does OCR PDF change how my scan looks?", "No, the page image stays in place. Forge Files adds an invisible text layer so PDF viewers can search the words."),
            ("Which languages are supported?", "The free OCR PDF tool is English-only today. Indic language OCR is planned as a premium expansion."),
            ("What is the difference from PDF to Text?", "OCR PDF returns a PDF with a searchable layer. PDF to Text returns a plain .txt file."),
        ],
        "related": ["make-pdf-searchable", "pdf-to-text", "pdf-to-word", "compress-pdf", "split-pdf"],
    },
    "ocr-hindi": {
        "title": "OCR Hindi PDF: Make Hindi PDFs Searchable Online | Forge Files",
        "meta": "OCR scanned Hindi PDFs into searchable PDFs online. Extract Devnagari script and add an invisible text layer. Free preview, secure, files auto-deleted.",
        "h1": "OCR Hindi PDF: Make Scanned Hindi PDFs Searchable",
        "lede": "Turn scanned Hindi documents, affidavits, and court notices into searchable PDFs. Recognize Devanagari script accurately with an invisible text layer behind the original scan.",
        "tool": "pdf", "app": "OCR Hindi PDF", "cta": "OCR Hindi PDF",
        "how": "How to OCR a Hindi PDF",
        "steps": [
            "Upload your scanned Hindi PDF or document.",
            "Select <strong>Hindi (हिन्दी)</strong> in the OCR language dropdown.",
            "Download your searchable PDF with full Devanagari text layer.",
        ],
        "benefits": [
            "<strong>High-accuracy Devanagari OCR:</strong> specifically tuned for Hindi government records, affidavits, and notices.",
            "<strong>Preserve original visuals:</strong> your scan layout and stamps remain intact while adding copyable, searchable text.",
            "<strong>Private and secure:</strong> all files are encrypted in transit and purged automatically after processing.",
        ],
        "faqs": [
            ("Can I search Hindi words using Ctrl+F after OCR?", "Yes! The output PDF contains an invisible Unicode text layer with Devanagari words."),
            ("What types of Hindi documents are supported?", "Scanned court documents, utility bills, affidavits, newspaper clips, and marksheets."),
            ("Is Hindi OCR free?", "English OCR is completely free. High-precision Indic languages (Hindi, Marathi, Tamil, Telugu) are available with Forge Files Premium."),
        ],
        "related": ["ocr-marathi", "ocr-pdf", "make-pdf-searchable", "pdf-to-text", "pdf-to-word"],
    },
    "ocr-marathi": {
        "title": "OCR Marathi PDF: Make Marathi PDFs Searchable Online | Forge Files",
        "meta": "OCR scanned Marathi PDFs online. Make 7/12 land extracts, marksheets, and official documents searchable with Devanagari OCR. Fast and secure.",
        "h1": "OCR Marathi PDF: Make Scanned Marathi PDFs Searchable",
        "lede": "Transform scanned Marathi PDFs, 7/12 (Satbara) extracts, and municipal bills into searchable documents. Adds a full Devanagari text layer without altering the scan.",
        "tool": "pdf", "app": "OCR Marathi PDF", "cta": "OCR Marathi PDF",
        "how": "How to OCR a Marathi PDF",
        "steps": [
            "Upload your scanned Marathi document or certificate.",
            "Select <strong>Marathi (मराठी)</strong> in the OCR language dropdown.",
            "Download the searchable PDF with invisible Unicode Marathi text.",
        ],
        "benefits": [
            "<strong>Tuned for Marathi documents:</strong> handles official Marathi government terminology, marksheets, and records.",
            "<strong>Search and copy text:</strong> search keywords with Ctrl+F or copy Devanagari text directly.",
            "<strong>Safe & confidential:</strong> files are strictly protected and automatically removed.",
        ],
        "faqs": [
            ("Can it OCR handwritten 7/12 extracts?", "Printed and clear official documents work best. High-resolution scans yield the best accuracy."),
            ("Does it support Devanagari script?", "Yes, Marathi uses the Devanagari script engine with full Unicode font mapping."),
            ("How do I access Marathi OCR?", "Select Marathi in the OCR PDF tool. Indic languages are available as part of Forge Files Premium."),
        ],
        "related": ["ocr-hindi", "ocr-pdf", "make-pdf-searchable", "pdf-to-text", "pdf-to-word"],
    },
    "ocr-tamil": {
        "title": "OCR Tamil PDF: Make Tamil PDFs Searchable Online | Forge Files",
        "meta": "OCR scanned Tamil PDFs into searchable PDFs online. Extract Tamil script accurately with an invisible text layer. Fast, private, and secure.",
        "h1": "OCR Tamil PDF: Make Scanned Tamil PDFs Searchable",
        "lede": "Convert scanned Tamil documents, electricity bills, and certificates into searchable PDFs. Retains scan quality while embedding an accurate Tamil Unicode text layer.",
        "tool": "pdf", "app": "OCR Tamil PDF", "cta": "OCR Tamil PDF",
        "how": "How to OCR a Tamil PDF",
        "steps": [
            "Upload your scanned Tamil PDF file.",
            "Choose <strong>Tamil (தமிழ்)</strong> as the OCR language.",
            "Download your searchable PDF with selectable Tamil text.",
        ],
        "benefits": [
            "<strong>Specialized Tamil OCR:</strong> recognizes modern Tamil script characters and ligatures.",
            "<strong>Invisible Unicode layer:</strong> search and copy Tamil text without modifying document appearance.",
            "<strong>Strict privacy:</strong> files are automatically deleted after processing.",
        ],
        "faqs": [
            ("Can I search Tamil words in Adobe Reader or Chrome?", "Yes, the embedded text layer supports Unicode search and copy."),
            ("Which Tamil documents can I OCR?", "Utility receipts, government orders, property deeds, and certificates."),
            ("Is Tamil OCR available?", "Yes! Tamil OCR is supported as an India-specific premium feature."),
        ],
        "related": ["ocr-telugu", "ocr-hindi", "ocr-pdf", "make-pdf-searchable", "pdf-to-word"],
    },
    "ocr-telugu": {
        "title": "OCR Telugu PDF: Make Telugu PDFs Searchable Online | Forge Files",
        "meta": "OCR scanned Telugu PDFs online. Add a searchable Telugu Unicode text layer to scanned certificates and documents. Fast, private, and secure.",
        "h1": "OCR Telugu PDF: Make Scanned Telugu PDFs Searchable",
        "lede": "Convert scanned Telugu PDFs into searchable, selectable documents. Adds an invisible Telugu text layer behind the scan for seamless keyword search and archiving.",
        "tool": "pdf", "app": "OCR Telugu PDF", "cta": "OCR Telugu PDF",
        "how": "How to OCR a Telugu PDF",
        "steps": [
            "Upload your scanned Telugu PDF.",
            "Select <strong>Telugu (తెలుగు)</strong> in the OCR language options.",
            "Download the searchable PDF with full Telugu text support.",
        ],
        "benefits": [
            "<strong>Native Telugu OCR:</strong> recognizes Telugu script characters and complex conjuncts.",
            "<strong>Preserve scan layout:</strong> keep original signatures, stamps, and layout intact.",
            "<strong>Automatic deletion:</strong> documents are processed securely and deleted promptly.",
        ],
        "faqs": [
            ("Does the output support Ctrl+F search?", "Yes, you can search and copy Telugu text directly in any modern PDF viewer."),
            ("What document formats are accepted?", "Any scanned or image-based PDF document."),
            ("How do I activate Telugu OCR?", "Select Telugu from the language dropdown in the OCR tool."),
        ],
        "related": ["ocr-tamil", "ocr-hindi", "ocr-pdf", "make-pdf-searchable", "pdf-to-word"],
    },
    "make-pdf-searchable": {
        "title": "Make PDF Searchable Online Free | Forge Files",
        "meta": "Make a scanned PDF searchable online with OCR. Add hidden text while preserving the original PDF look. Free, no signup, files auto-deleted.",
        "h1": "Make PDF Searchable",
        "lede": "Have a scanned PDF that Chrome, Preview, or Ctrl+F cannot search? Add an OCR text layer and keep the document looking the same.",
        "tool": "pdf", "app": "OCR PDF", "cta": "Make PDF searchable",
        "how": "How to make a PDF searchable",
        "steps": [
            "Upload the scanned PDF.",
            "Choose <strong>OCR PDF</strong> in the PDF tools.",
            "Download the searchable PDF with its invisible text layer.",
        ],
        "benefits": [
            "<strong>Same PDF, searchable words:</strong> no visual rerasterization or watermark.",
            "<strong>Useful for scans:</strong> marksheets, applications, invoices, and forms become searchable in regular PDF viewers.",
            "<strong>Free and private:</strong> no signup, with automatic deletion after processing.",
        ],
        "faqs": [
            ("Will this create a Word file?", "No. This keeps the output as a PDF. Use <a href=\"/pdf-to-word\">PDF to Word</a> when you need DOCX."),
            ("Can I copy text after OCR?", "Most PDF viewers can select or search the OCR layer, although exact selection quality depends on the scan."),
            ("Can I still extract plain text?", "Yes, use <a href=\"/pdf-to-text\">PDF to Text</a> for a .txt export."),
        ],
    ...
    "split-pdf": {
        ...
        "meta": "Split a PDF into separate PDF files inside one ZIP. Split every page, every N pages, or custom ranges like 1-5,6-10. Free, private, no signup.",
        "h1": "Split PDF Into Separate Files",
        "lede": "Turn one PDF into a ZIP of smaller PDFs: one file per page, every few pages, or custom chapter ranges. Extract Pages stays available when you want one combined output.",
        "tool": "pdf", "app": "Split PDF", "cta": "Split a PDF now, free",
        "how": "How to split a PDF",
        "steps": [
            "Upload your PDF (drag &amp; drop or browse).",
            "Choose <strong>Split PDF</strong> and pick every page, every N pages, or custom ranges like <code>1-5,6-10,11</code>.",
            "Download a ZIP containing the separate PDFs. The original upload is deleted automatically.",
        ],
        "benefits": [
            "<strong>Real split output:</strong> get many PDFs in one ZIP instead of running extraction again and again.",
            "<strong>Flexible modes:</strong> split every page, fixed-size chunks, or custom chapter-style ranges.",
        ...
        "faqs": [
            ("How is splitting different from extracting pages?", "Split PDF creates several PDFs inside a ZIP. Extract Pages creates one new PDF containing the pages you selected."),
            ("Can I split one PDF into several separate files?", "Yes. Choose every page, every N pages, or enter ranges like <code>1-5,6-10,11</code> to create several files in one run."),
