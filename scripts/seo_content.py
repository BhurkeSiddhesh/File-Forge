...
TOOL_PAGES: Dict[str, dict] = {
    ...
    "pdf-to-word": {
        ...
        "lede": "Turn any PDF into an editable Word (DOCX) document in seconds. Fix a typo in a contract, reuse a report, or edit a form — without retyping a single line.",
    ...
    "merge-pdf": {
        ...
        "lede": "Joining a cover letter, résumé, and certificates into a single application? Combine any number of PDFs into one clean document, in the order you choose — free, no software to install.",
    ...
    "watermark-pdf": {
        ...
        "lede": "Mark a document as DRAFT, CONFIDENTIAL, or with your name across every page. Add a text watermark with the position and transparency you choose — free, no software needed.",
    ...
    "compress-image": {
        ...
        "lede": "Photos too heavy to email or slowing down your website? Compress them to a fraction of the size with a quality slider you control — free, no signup, no watermark.",
    ...
    "convert-image": {
        ...
        "faqs": [
            ...
            ("When should I use WebP?", "WebP usually produces smaller files than JPG or PNG at similar quality — great for websites and faster page loads."),
    ...
    "watermark-image": {
        ...
        "lede": "Protect a photo or brand it with your name. Stamp text onto any image with the position, color, and opacity you choose — free, and we never add a watermark of our own.",
    ...
    "excel-to-pdf": {
        ...
        "lede": "Share a spreadsheet that looks the same on every device. Convert your Excel workbook to a clean PDF — each sheet rendered as a tidy table — free and without Office installed.",
